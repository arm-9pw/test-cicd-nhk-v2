...
const BCSTable: React.FC<Props> = ({ budgetType, budgetControlSheetData = [] }) => {
  const dataColumnsWidth = (100 - 35) / budgetControlSheetData.length
  return (
    <div className={styles['budget-table-wrap']}>
      <table className={styles['budget-table']}>
        <tbody>
          <tr>
            <th
              colSpan={3 + budgetControlSheetData.length}
              style={{ backgroundColor: clrWhite, padding: 0, border: 'none' }}
            >
              <div className={styles['budget-table-header']}>Budget Control Sheet</div>
            </th>
          </tr>
          <tr>
            <td colSpan={3 + budgetControlSheetData.length}>
          ...
          <tr>
            <th colSpan={3} style={{ width: `${dataColumnsWidth}%`, textAlign: 'left' }}>
              Budget Year
            </th>

            {budgetControlSheetData.map((data, index) => (
          ...
          <tr>
            <td colSpan={2}>
              <div className={styles['split-text']}>Budget Number</div>
            </td>
          ...
          <tr>
            ...
            <td colSpan={budgetControlSheetData.length}>
              <Form.Item name="remarkBudgetControlSheet">
                <TextArea rows={2} />
              </Form.Item>
            </td>
          </tr>
