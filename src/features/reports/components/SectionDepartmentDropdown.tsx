...
import { useLazyListSectionDepartmentQuery } from 'api/employeeApi'
...
const SectionDepartmentDropdown: React.FC<Props> = ({
  siteCode,
  formName,
  formLabel,
  ...
  const [triggerGetSections, { data = [], currentData, isFetching }] = useLazyListSectionDepartmentQuery()
...
export default SectionDepartmentDropdown