...
import { Button, Divider, Empty, Result, Space, Spin } from 'antd'

import styles from '../../../features/approvals/MyApprovals/components/ApprovalDetailModal/styles.module.css'
...
import useApprovalRoute from 'features/approvals/MyApprovals/components/ApprovalDetailModal/hooks/useApprovalRoute'
import useDocumentData from 'features/approvals/MyApprovals/components/ApprovalDetailModal/hooks/useDocumentData'
import useDocumentHandling from 'features/approvals/MyApprovals/components/ApprovalDetailModal/hooks/useDocumentHandling'
import ApproveRejectModal from 'features/approvals/MyApprovals/components/ApproveRejectModal'
import AttachmentsList from 'features/approvals/MyApprovals/components/AttachmentsList'
import DocumentPreview from 'features/approvals/MyApprovals/components/DocumentPreview'
import MainDocumentList from 'features/approvals/MyApprovals/components/MainDocumentList'
...
const DocumentDetail = ({
  ...
  const { approvalRoute, approvalRouteError, approvalRouteLoading } = useApprovalRoute(selectedItem)
  ...
  const {
    ...
    isDownloadLoading,
  } = useDocumentHandling({ selectedItem, customToken })

  const activeStep = approvalRoute?.approvalSteps?.find((step) => step.active)
  const canApproveReject =
    !approvalRouteError && activeStep && userInfo?.employeeId === activeStep.activeApproverId
